          ...
          <div class="col-lg-4">
            ...
            <div class="card card-fluid">
              ...
              <nav class="nav nav-tabs flex-column border-0">
                <a href="user-profile-settings.html" class="nav-link active">List Organizations</a> <a href="user-account-settings.html" class="nav-link"><i class="fas fa-plus"></i> Create New</a>
              </nav><!-- /.nav -->
            </div><!-- /.card -->
          </div><!-- /grid column -->
          <!-- grid column -->
