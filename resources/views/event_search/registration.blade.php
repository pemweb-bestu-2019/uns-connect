                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Gunakan invoice ini sebagai bukti pembayaran kamu.</p>
                            <hr>
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-10">
                                        ...
                                        <dl>
                                            <dt> Name </dt>
                                            <dd> {{ auth()->user()->member->name }} </dd>
                                            <dt> Email Address </dt>
                                            <dd> {{ auth()->user()->email }} </dd>
                                            <dt> Buy Date </dt>
                                            <dd> {{ $invoice->created_at->format('F jS, Y') }} </dd>
                                        </dl>

                                        <p><strong>This event supported by:</strong></p>
                                        <svg xmlns:xlink="http://www.w3.org/1999/xlink"
                                            xmlns="http://www.w3.org/2000/svg" stroke-linecap="round"
                                            stroke="currentColor" fill="none" class="_1bmwm" viewBox="0 0 135 43"
                                            height="32" width="135">
                                            <g id="Train_Booking" stroke="none" stroke-width="1" fill="none"
                                                fill-rule="evenodd">
                                                <g id="Train_Booking-Form_Login-Success"
                                                    transform="translate(-174.000000, -10.000000)">
                                                    <g id="Logo-/-Normal-Text-Copy-2"
                                                        transform="translate(174.000000, 10.000000)">
                                                        <g id="Icon-Blue-Copy"
                        ...
                        <div class="card-body">
                            <h4 class="card-title"> Registration has been Closed </h4>
                            <hr>
                            <p>Pendaftaran untuk event ini telah berakhir, anda bisa mengecek event lain untuk mendaftar
                                ya.</p>
                        </div>
                        @else
                        <div class="card-body">
